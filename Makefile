...
super-lint:
	...
	@docker run --rm \
		...
		-e LINTER_RULES_PATH=. \
		-e VALIDATE_JUPYTER=false \
		-e VALIDATE_PYTHON_NBQA=false \
		-e VALIDATE_PYTHON_NBQA_BLACK=false \
		-e VALIDATE_PYTHON_NBQA_FLAKE8=false \
		-e VALIDATE_PYTHON_NBQA_ISORT=false \
